...
//
//            /*
//             * Для импорта данных надо раскомментировать importData и закомментировать
//             * следующие строчки:
...
public class App {
    ...
    public ElasticsearchClient elasticsearchClient() {
        ...
        try {
            ...
            System.out.println("[OK] Connected to Elasticsearch. Version: " + info.version().number());
        } catch (Exception e) {
            System.err.println("[ERROR] Failed to connect to Elasticsearch: " + e.getMessage());
        }
    ...
    public static class SearchController {
        ...
        public Map<String, Object> search(@RequestBody Map<String, String> request) {
            ...
            try {
                ...
                long elapsed = results.isEmpty() ? 0L : ((Number) results.get(0).getOrDefault("elapsedMs", 0L)).longValue();
                ...
                return Map.of(
                        "success", false,
                        "error", "Ошибка при выполнении запроса в Elasticsearch: " + e.getMessage()
                );
            }
        }
    }
